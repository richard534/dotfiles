...
(use-package cider
  ...
  ; Workaround for company bindings - see https://github.com/hlissner/doom-emacs/issues/1335  ;;;;

  (defun rst/set-company-maps (&rest unused)
  ...
  (defun rst/unset-company-maps (&rest unused)
    (define-key evil-insert-state-map (kbd "C-j") nil)
    (define-key evil-insert-state-map (kbd "C-k") nil))

  (add-hook 'company-completion-started-hook 'rst/set-company-maps)
  (add-hook 'company-completion-finished-hook 'rst/unset-company-maps)
  (add-hook 'company-completion-cancelled-hook 'rst/unset-company-maps))
#+end_src
** Smartparens
#+begin_src emacs-lisp
