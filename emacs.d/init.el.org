...
#+END_SRC
When opening a file from file browser (E.g finder) - don't open a new emacs window, open a new buffer
#+begin_src emacs-lisp
...
(use-package evil-leader
  ...
  (evil-leader/set-key
    ...
    "fm" 'move-file-and-buffer-to-dir
...
(use-package eyebrowse
  ...
  (evil-leader/set-key
    ; Switch to window 0-9 configs
    "lw0"    'eyebrowse-switch-to-window-config-0
    ...
    "lww"    'eyebrowse-last-window-config
    "lwW"    'eyebrowse-switch-to-window-config

    "lwc"    'eyebrowse-create-window-config
    "lwl"    'eyebrowse-next-window-config
    "lwh"    'eyebrowse-prev-window-config
    "lwR"    'eyebrowse-rename-window-config
    "lwd"    'eyebrowse-close-window-config)
...
(use-package helm
  ...
  ; TODO test if these are any good
  ;; (setq
  ...
  (evil-leader/set-key
    ;; Finding files (f)
    ; Find file (ff)
    "ff" 'helm-find-files ; Current dir file search
    ;; "fF" 'counsel-find-file-region-or-symbol ; Current dir file search ; TODO
    "fl" 'find-file-literally

    ;; ; Find file in project (fp)
    ;; "fp" 'helm-projectile-find-file
    ;; "fP" 'counsel-fzf-region-or-symbol TODO

    ;;; Searching (s)
    "sc" 'evil-ex-nohighlight ; clear highlights
    ;; Current file (ss)
    "sj" 'helm-semantic-or-imenu ; mnemonic - search-jump (list all symbols in buffer)
    "ss" 'helm-swoop ; TODO stop this from grabbing word @ point. I want no input
    "sS" 'helm-swoop
    ;; Arbitrary directory (sf)
    "sf" 'helm-ag
    ;; "sF" 'counsel-rg-current-dir-region-or-symbol TODO
    ;; ;; Open buffers (sb)
    "sb" 'helm-multi-swoop-all
    ;; "sB" 'swiper-all-region-or-symbol TODO
...
(use-package helm-projectile
  ...
  (evil-leader/set-key
    ...
    ;; "pF" 'counsel-projectile-find-file-dwim ; TODO
    "pb" 'helm-projectile-switch-to-buffer
    "ps" 'helm-projectile-ag
    ;; "sP" 'counsel-projectile-rg-region-or-symbol ; TODO
    "pD" 'projectile-dired
...
(use-package elpy
  ...
  (evil-leader/set-key-for-mode 'python-mode
    ...
    "mvw" 'pyvenv-workon
    "mr"  'pyvenv-restart-python)

  (evil-add-command-properties 'elpy-goto-definition :jump t)
  (evil-add-command-properties 'elpy-goto-assignment :jump t)

  ; Set envar $WORKON_HOME envar. Used by pyvenv-workon fn
...
Move current file/buffer to target dir
Source: https://sites.google.com/site/steveyegge2/my-dot-emacs-file
#+begin_src emacs-lisp
